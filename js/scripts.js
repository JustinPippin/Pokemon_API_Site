//JQuery function to make suremno code is run until the HTML is fully loaded
$(function() {
    //When the page loads, the Pokemion info card should be hidden by default
    ...
    $("#search").click(function() {
        ...
        //Remove old infro from the Pokemon information list
    ...
    function getPokemonInfo(nameOrID) {
        //Connect with the web server & get a response
        //Do this with the response

        //We need a way to asynchronously handle making the API call and doing stuff when we get a response since we don't know how long it will take to get a reponse.
        ...
        $.ajax({
            ...
            success: function(result) {
                //Pulling the Pokemon's name from the JSON we get
